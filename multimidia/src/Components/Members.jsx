  ...
  return (
    <section className={styles.container}>
      <div className={styles.content}>
        ...
        <button className={styles.know} onClick={buttonkhow}> CONHEÇA-LO </button>
      </div>

      <div className={styles.lideres}>
        <button onClick={() => {selecname(6), changeimage(3)}} className={styles.victor}></button>
        {/* Victor */}
        <button
          onClick={() => {selecname(0), changeimage(4)}}
      ...
      <div className={styles.select}>
        ...
        {/* Guilherme */}
        <button
          onClick={() => {selecname(5), changeimage(1)}}
          className={styles.alice}
        ></button>
        {/* Alice */}
        <button
          onClick={() => {selecname(4), changeimage(2)}}
          className={styles.laura}
        ></button>
        {/* Laura */}
        <button
          onClick={() => {selecname(7), changeimage(5)}}
          className={styles.henrique}
        ></button>
        {/* Henrique */}
        <button
          onClick={() => {selecname(3), changeimage(5)}}
